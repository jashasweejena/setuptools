...
tput setaf 2
rm -rf device/yu/jalebi device/cyanogen/msm8916-common kernel/ vendor/yu
tput setaf 1
...
tput setaf 2
git clone https://github.com/CyanogenMod/android_kernel_cyanogen_msm8916 -b cm-13.0 kernel/cyanogen/msm8916/
tput setaf 1
